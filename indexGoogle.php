	...
	<main class="containerSearch" id="root">
		...
		<script type="text/javascript">
			var vue = new Vue({
				...
				mounted: function(){
					this.$http.get('/git/acweather/fetchLocationGoogle.php?city='+this.city).then(function(cityName){
						this.degree = cityName.data[1];
						this.wind = cityName.data[2];
						this.humidity = cityName.data[3];
						this.description = cityName.data[4];
						this.description = cityName.data;
					});
				},
			});
		</script>
